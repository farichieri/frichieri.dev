...
const MobileNav: FC<Props> = ({ isOpen, onClick }) => {
  return (
    <div
      ...
      } absolute z-[90] top-0 pt-[var(--navHeight)] flex h-screen w-full text-[var(--textColor)] flex-col items-center dark:bg-black bg-white px-4 shadow-sm transition-all duration-300 dark:shadow-cyan-100/20 md:hidden `}
    >
